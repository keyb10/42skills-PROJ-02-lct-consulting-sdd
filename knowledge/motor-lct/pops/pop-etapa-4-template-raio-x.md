---
name: pop-etapa-4-template-raio-x
description: Etapa 4 do D1 — Template do Relatório Executivo Raio-X (entregável-âncora) para Apresentação 90 min + upsell estruturado. Estrutura 9-páginas (4 Camadas + simulação + caminhos)
version: 2.0.0 (v1.0.0 original reativada 2026-07-10 após v0.0.4 do Motor)
applies_to: [LCT Consulting / Degrau 1 / Etapa 4 - Apresentação + Upsell]
caps_referenced:
