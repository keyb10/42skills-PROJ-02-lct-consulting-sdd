---
name: pop-pulse-clientes-atuais
description: Mapeamento dos clientes atuais via Matriz Valor×Fit (Cap. 08) + lista de expansão orgânica + 2 perguntas provocadoras para fechar D1×C3. Saída: seção "Pulse dos Clientes Atuais" do Raio-X
version: 1.0.0
