---
name: pop-auditoria-maquina-cliente
description: Auditoria operacional leve da máquina-cliente (D1×C2) — roteiro de 90 min para mapear 4 Fundamentos desalinhados (PMF/ICP/Oferta/Roadmap), processos críticos, gargalos e oportunidades de IA. Saída: seção "Mapa de ineficiência" do Raio-X
version: 1.0.0
